                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <label for=""><input type="radio" name="discount_type" class="fixed" value="fixed"/> fixed </label>
                                                    <label for=""><input type="radio" name="discount_type" class="percent" value="percent"/> percent </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
