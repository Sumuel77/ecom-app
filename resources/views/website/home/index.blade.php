                ...
                <div class="row">
                        ...
                        <div class="slide-1 no-arrow">
                            <div>
                                <div class="slide-main">
                                    <img src="{{asset('/')}}website/assets/images/mega-store/slider/1.jpg" class="img-fluid bg-img" alt="mega-store">
                                    <div class="slide-contain">
                                        <div>
                                            <h4>all product</h4>
                                            <h2>megastore</h2>
                                            <h3>save up to 20% off</h3>
                                            <a href="product-page(left-sidebar).html" class="btn btn-rounded btn-md">
                                                Shop Now
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div>
                                <div class="slide-main">
                                    <img src="{{asset('/')}}website/assets/images/mega-store/slider/2.jpg" class="img-fluid bg-img" alt="mega-store">
                                    <div class="slide-contain">
                                        <div>
                                            <h4>all product</h4>
                                            <h2>megastore</h2>
                            ...
                            <div>
                                <div class="slide-main">
                                    <img src="{{asset('/')}}website/assets/images/mega-store/slider/3.jpg" class="img-fluid bg-img" alt="mega-store">
                                    <div class="slide-contain">
                                        <div>
                                            <h4>all product</h4>
                                            <h2>megastore</h2>
                    ...
                    <div class="col-md-6">
                        <div class="collection-banner-main banner-18 banner-style7 collection-color13 p-left text-center">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/slider/banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="collection-banner-main banner-18 banner-style7 collection-color9 p-left text-center">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/slider/banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>stylish chair</h3>
                ...
                <div class="row collection-p6">
                    <div class="col-xl-12 col-lg-4 col-md-6">
                        <div class="collection-banner-main banner-17 banner-style7 collection-color14 p-left text-center">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/slider/banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>smart glasses</h3>
                    ...
                    <div class="col-xl-12 col-lg-4 col-md-6">
                        <div class="collection-banner-main banner-17 banner-style7 collection-color15 p-left text-center">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/slider/banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>smart led tv</h3>
                    ...
                    <div class="col-xl-12 col-lg-4 col-md-12">
                        <div class="collection-banner-main banner-18 banner-style7  p-left text-center">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/slider/banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>smart phone</h3>
        ...
        <div class="row collection-p4">
            <div class="col-md-4">
                <div class="collection-banner-main p-center text-center p-top banner-16 banner-style7">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/mega-store/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                    ...
                    <div class="col-12">
                        <div class="collection-banner-main p-left text-center banner-13 banner-style7">
                            <div class="collection-img">
                                <img src="{{asset('/')}}website/assets/images/mega-store/collection-banner/3.jpg" class="img-fluid bg-img  " alt="banner">
                            </div>
                            <div class="collection-banner-contain ">
                                <div>
                                    <h3>relex camera</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-center p-top text-center banner-16 banner-style7">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/mega-store/collection-banner/4.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain ">
                        <div>
...
<section class="sale-banenr banner-style2  section-big-mb-space">
    <img src="{{asset('/')}}website/assets/images/mega-store/sale-banner/1.jpg" alt="sale-banenr" class="img-fluid bg-img">
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/1.jpg" alt="product">
                                                    </a>
                                                </div>
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/2.jpg" alt="product">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="product-detail">
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/3.jpg" alt="product">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="product-detail">
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/4.jpg" alt="product">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="product-detail">
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/5.jpg" alt="product">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="product-detail">
                                    ...
                                    <div>
                                        <div class="product-box3">
                                            <div class="media">
                                                <div class="img-wrapper">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img class="img-fluid" src="{{asset('/')}}website/assets/images/mega-store/media-product/6.jpg" alt="product">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="product-detail">
