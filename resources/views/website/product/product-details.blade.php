                                            ...
                                            <div id="selectSize" class="pro-group addeffect-section product-description border-product">
                                                ...
                                                <div class="size-box">
                                                    @foreach($productSizes as $key => $productSize)
                                                        <label> <input type="radio" {{ $key == 0 ? 'checked' : '' }} name="size" value="{{$productSize->size->name}}"/> {{$productSize->size->name}} </label>
                                                    @endforeach
                                                </div>
...
{{--                                                        <label> <input type="checkbox" {{ $key1 == 0 ? 'checked' : '' }} name="color" value="{{$productColor->color->name}}"/> {{$productColor->color->name}} </label>--}}
                                                ...
                                                <div class="product-buttons">
                                                    ...
                                                    <a href="{{ route('customer.wishlist',['id'=>$product->id]) }}" class="btn btn-normal add-to-wish tooltip-top" data-tippy-content="Add to wishlist">
                                            ...
                                            <div class="pro-group">
                                                ...
                                                <div class="pro-group pb-0">
                                                    ...
                                                    <ul class="product-social">
                                                        ...
                                                        <li><a href="javascript:void(0)"><i class="fa fa-instagram-square"></i></a></li>
